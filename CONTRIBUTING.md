...
3. Keep portable behavior independent of Codex, Claude Code, Kimi Code and OpenCode. Harness-specific behavior belongs in a thin adapter.
...
Keep each pull request to one reviewable change. Explain the capability, evidence, provenance classification and any harness-specific limitations. A contribution is not ready while tests fail or its provenance record is missing.
